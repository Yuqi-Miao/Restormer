...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--train_bs", type=int, default=2, help="size of the training batches (train_bs per GPU)")
        ...
        self.parser.add_argument("--num_workers", type=int, default=10, help="number of cpu threads to use during batch generation")
        # ---------------------------------------- step 3/5 : model defining... ------------------------------------------------
        # 如果在命令行中出现了--data_parallel，则使用多GPU训练
        ...
        self.parser.add_argument("--n_epochs", type=int, default=1800, help="number of epochs of training")
        
        # ---------------------------------------- step 5/5 : training... ------------------------------------------------
        self.parser.add_argument("--print_gap", type=int, default=50, help="the gap between two print operations, in iteration")
        self.parser.add_argument("--val_gap", type=int, default=3, help="the gap between two validations, also the gap between two saving operation, in epoch")
        self.parser.add_argument("--lambda_fft", type=float, default=0.01, help="the weight of the fft loss")
...
class TestOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--experiment", type=str, default='restormer', help="name of experiment")
