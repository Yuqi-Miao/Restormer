...
class MDTA(nn.Module):
    def __init__(self, channels, num_heads):
        ...
        self.qkv = nn.Conv2d(channels, channels, kernel_size=1, bias=False)
        self.qkv1 = nn.Conv2d(channels, channels, kernel_size=1, bias=False)
        self.qkv2 = nn.Conv2d(channels, channels, kernel_size=1, bias=False)

        self.qkv_conv = nn.Conv2d(channels, channels, kernel_size=3, padding=1, groups=channels, bias=False)
        self.qkv_conv1 = nn.Conv2d(channels, channels, kernel_size=3, padding=1, groups=channels, bias=False)
        self.qkv_conv2 = nn.Conv2d(channels, channels, kernel_size=3, padding=1, groups=channels, bias=False)
    ...
    def forward(self, x):
        ...
        k = q
        v = q
        q = self.qkv_conv(self.qkv(q))
        k = self.qkv_conv1(self.qkv1(k))
        v = self.qkv_conv2(self.qkv2(v))
...
class Restormer(nn.Module):
    def __init__(self, num_blocks=[2, 2, 4, 6], num_heads=[6, 6, 6, 6], channels=[48, 96, 192, 384], num_refinement=4,
